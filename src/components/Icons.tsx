...
function CaretDownIcon({ size = DEFAULT_SIZE, title, ...props }: IconProps) {
  return (
    <SvgBase {...props} size={size} title={title}>
...
function CaretUpIcon({ size = DEFAULT_SIZE, title, ...props }: IconProps) {
  return (
    <SvgBase {...props} size={size} title={title}>
      <path d="M480-600 280-400h400L480-600Z" />
    </SvgBase>
  );
}
...
function ShareIcon({ size = DEFAULT_SIZE, title, ...props }: IconProps) {
  return (
    <SvgBase {...props} size={size} title={title}>
...
function VaccinationIcon({ size = DEFAULT_SIZE, title, ...props }: IconProps): React.ReactElement {
  return (
    <SvgBase {...props} size={size} title={title}>
...
function CopyIcon({ size = DEFAULT_SIZE, title, ...props }: IconProps): React.ReactElement {
  return (
    <SvgBase {...props} size={size} title={title}>
