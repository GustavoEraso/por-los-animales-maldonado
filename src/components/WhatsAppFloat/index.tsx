 ...
 */
function MessageCircleIcon({ size = 24, className = '' }: { size?: number; className?: string }): React.ReactElement {
  return (
    <svg 
      width={size} 
      height={size} 
 ...
 */
function XIcon({ size = 20, className = '' }: { size?: number; className?: string }): React.ReactElement {
  return (
    <svg 
      width={size} 
      height={size} 
 ...
 */
function PhoneIcon({ size = 16, className = '' }: { size?: number; className?: string }): React.ReactElement {
  return (
    <svg 
      width={size} 
      height={size} 
            ...
            contacts.map((contact, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500">{formatPhone(contact.phone, contact.countryCode)}</p>
