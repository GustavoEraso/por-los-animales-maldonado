    ...
    <div>
      ...
      <section className="flex flex-col items-center justify-center p-8 w-full   text-black text-lg">
        <p className="max-w-7xl">
          Las suscripciones económicas de ustedes son nuestro respaldo fundamental para continuar
          con nuestra labor. Los aportes recurrentes se destinan principalmente a cubrir atención
          veterinaria (cirugías, tratamientos, análisis, medicación, honorarios) y también a la
          compra de insumos y alimento para nuestros rescatados.
        </p>
      </section>
