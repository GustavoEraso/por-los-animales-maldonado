...
export default function Compartir() {
    ...
    const [animalDataToShow, setAnimalDataToShow] = useState<Record<string, boolean>>(initialAnimalDataToShow)
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-1 sm:p-8">
                    ...
                    <main className="lg:col-span-2 flex flex-col gap-8 items-center w-full rounded-xl border border-amber-sunset shadow-sm  p-16">
                        <section className="flex flex-col gap-3 items-center sticky top-2">
                            ...
                            <div className="skeleton text-transparent px-4 py-2 rounded">
                                cargando...
                            </div>
                        </section>
                    </main>
                ...
                <aside className='flex flex-col gap-6 lg:col-span-1 w-full'>
                    ...
                    <section className='flex flex-col gap-6 p-6 rounded-xl border border-amber-sunset py-6 shadow-sm bg-amber-50'>
                        <div className="space-y-3">
                            ...
                            {colorSchemes.map((scheme, index) => (
                                <div
                                    key={index}
                                    className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md ${selectedColorScheme.name === scheme.name
                    ...
                    <section className='flex flex-col gap-6 p-6 rounded-xl border border-amber-sunset py-6 shadow-sm bg-amber-50'>
                        <div className="space-y-3">
                            ...
                            {formatPresets.map((format, index) => (
                                <div
                                    key={index}
                                    className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md ${selectedFormat.key === format.key
                                        ? "border-red-600 bg-red-50"
                                        : "border-gray-200 hover:border-red-300"
                                        }`}
                    ...
                    <section className='flex flex-col gap-6 p-6 rounded-xl border border-amber-sunset py-6 shadow-sm bg-amber-50'>
                        <div className="space-y-3">
                            ...
                            {titles.map((title, index) => (
                                <div
                                    key={index}
                                    className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md ${selectedTitle === title
                                        ? "border-red-600 bg-red-50"
                                        : "border-gray-200 hover:border-red-300"
                                        }`}
                            ...
                            <div className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md ${!titles.some((title) => title === selectedTitle)
                                ? "border-red-600 bg-red-50"
                                : "border-gray-200 hover:border-red-300"
                                }`}>
                    ...
                    <section className='flex flex-col gap-6 p-6 rounded-xl border border-amber-sunset py-6 shadow-sm bg-amber-50'>
                        <div className="space-y-3">
                            ...
                            {someCompatibility && <div className='p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md border-gray-200 hover:border-red-300'>
                                <label className="flex gap-2 cursor-pointer w-fit  font-bold text-balance items-center">
                    ...
                    <section className='flex flex-col gap-6 p-6 rounded-xl border border-amber-sunset py-6 shadow-sm bg-amber-50'>
                        <div className="space-y-3">
                            ...
                            {contacts.map((contact, index) => (
                                <div
                                    key={index}
                                    className={`p-3 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md ${selectedContacts.includes(index)
                                        ? "border-red-600 bg-red-50"
                                        : "border-gray-200 hover:border-red-300"
                                        }`}
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className={`w-5 h-5 rounded border-2 flex items-center justify-center ${selectedContacts.includes(index)
                        ...
                        >
                            ...
                            <section style={{ backgroundColor: selectedColorScheme.primary }} className='flex bg-green-forest text-cream-light w-full h-full overflow-y-hidden'>
                                ...
                                <div className={`w-3/7 flex flex-col items-stretch justify-around  p-1 relative ${selectedFormat.key === 'story' ? 'py-8' : ''}`}>
                                    ...
                                    <ul style={{ fontSize: `${itemsSize}px` }} className='flex flex-col h-full justify-around p-1 '>
                                        {animalDataToShow.gender && <li className="  capitalize"> {animal.gender}</li>}
                                        {animalDataToShow.aproxBirthDate && <li className="  capitalize"> {yearsOrMonthsElapsed(animal.aproxBirthDate)}</li>}
                                        ...
                                        {animalDataToShow.isAvalible && <li className="  text-balance  leading-none" > {animal.isAvalible ? 'Pronto para encontrar hogar' : 'En recuperación'}</li>}
                                        {animalDataToShow.isSterilized && <li className="  text-balance  leading-none">
                                    ...
                                    <div className='py-2'>
                                        {((animalDataToShow.compatibility && someCompatibility) || infoText !== '') && <p className='border-b-2 mb-1 '>+info</p>}
                                        <p className='leading-none max-w-full break-words '>{infoText}</p>

                                        {(animalDataToShow.compatibility && someCompatibility) && (<div className=' flex flex-col'>
                            ...
                            <footer style={{ backgroundColor: selectedColorScheme.accent }} className=' relative flex flex-col w-full pb-1 '>
                                <div className='relative w-full flex items-center justify-around p-1 '>
                                    ...
                                    <QRCode value={`www.porlosanimalesmaldonado.com/adopta/${animal.id}`} size={60} level="H" />
                                </div>
