  ...
  return (
    <div className="flex flex-col items-center min-h-screen font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col w-full  items-center justify-center">
        ...
        <section className="flex flex-col items-center justify-center w-full bg-beige-light px-6">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-full max-w-6xl py-16">
            ...
            <div className="flex flex-col gap-4 font-barlow text-start text-dark-text px-2">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                <Link href="/adopta#antes-de-adoptar" className="w-fit text-2xl rounded-full px-4 py-2 transition duration-300 ease-in-out text-white bg-red-heart hover:bg-green-olive uppercase">
                  Antes de adoptar
                </Link>
                <Link href="/adopta#requisitos" className="w-fit text-2xl rounded-full px-4 py-2 transition duration-300 ease-in-out text-white bg-red-heart hover:bg-green-olive uppercase">
                  Requisitos
                </Link>
        ...
        <section className="flex flex-col items-center justify-center w-full bg-beige-light px-6">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-8 items-center justify-center w-full max-w-6xl py-16">
            ...
            <div className="flex flex-col gap-4 font-barlow text-start text-dark-text px-2">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                <Link href="/involucrate" className="w-fit text-2xl rounded-full px-4 py-2 transition duration-300 ease-in-out text-white bg-red-heart hover:bg-green-olive uppercase">
                  ver más
                </Link>
              ...
              >
                <span className="flex justify-center items-center p-4 rounded-full gap-2 text-2xl hover:bg-white transition duration-300 ease-in-out">
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-6 h-6 text-dark-text hover:text-dark-text-300"
                  >
