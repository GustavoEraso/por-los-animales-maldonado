...
function ThanksContent() {
  ...
  return (
    <>
      <h1 className="text-3xl lg:text-5xl font-bold text-center text-balance text-black">
        ¡Gracias <span className="capitalize">{name}</span>!
      </h1>
      <p className="text-lg lg:text-xl text-center text-balance text-gray-700">
        Tu {contributionType[type]} de {amount} {currency}
        {type === 'suscription' ? ' al mes' : ''} es muy valiosa para nosotros.
      </p>
      <p className="text-lg lg:text-xl text-center text-balance text-gray-700">
