 ...
 *
 * Internal API endpoint that fetches all animals from Firestore database.
 * This endpoint is protected with an internal token and cached for 60 seconds
 * to improve performance. Used by other APIs to get fresh animal data.
 *
 ...
 *
 * @returns {NextResponse<Animal[]>} JSON response with all animals from Firestore
 ...
 * const response = await fetch('/api/animals-cache', {
 *   headers: {
