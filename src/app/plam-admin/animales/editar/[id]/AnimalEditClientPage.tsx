...
interface AnimalEditClientPageProps {
  animalId: string;
}

/**
 * Client-side animal edit form.
 *
 * @param props - Resolved dynamic route parameters
 * @returns The interactive animal edit form
 */
export default function AnimalEditClientPage({
  animalId,
}: AnimalEditClientPageProps): React.ReactElement {
  const router = useRouter();
  const currentId = animalId;
