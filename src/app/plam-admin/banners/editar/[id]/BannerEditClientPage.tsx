...
interface BannerEditClientPageProps {
  bannerId: string;
}

/**
 * Client-side banner edit form.
 *
 * @param props - Resolved dynamic route parameters
 * @returns The interactive banner edit form
 */
export default function BannerEditClientPage({
  bannerId,
}: BannerEditClientPageProps): React.ReactElement {
  const router = useRouter();
  const currentId = bannerId;
