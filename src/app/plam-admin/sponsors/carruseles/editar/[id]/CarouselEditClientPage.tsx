 ...
 */
interface CarouselEditClientPageProps {
  carouselId: string;
}

export default function CarouselEditClientPage({
  carouselId,
}: CarouselEditClientPageProps): React.ReactElement {
  const router = useRouter();
  const currentId = carouselId;
