...
interface SponsorEditClientPageProps {
  sponsorId: string;
}
 ...
 */
export default function SponsorEditClientPage({
  sponsorId,
}: SponsorEditClientPageProps): React.ReactElement {
  const router = useRouter();
  const currentId = sponsorId;
